...
import unittest
from constants import LONG, SHORT, OUT, BTCUSDT, ETHUSDT, SPOT, FUTURES, STOP_MARKET, TYPE, SYMBOL
...
def test_compute_side(symbol):
        master_api = ApiKeyMaster([API_KEY_SLAVE, API_KEY_SLAVE_SECRET, OUT, FUTURES, ETHUSDT])
