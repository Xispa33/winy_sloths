...
class CEP__Binance(CryptoExchangePlatform):
    ...
    def futures_create_order(self, symbol, side, _type, quantity, positionSide=0):
        ...
        if (positionSide != 0):
            request_parameters[POSITION_SIDE] = positionSide
    ...
    def cep__open_short(self, symbol, leverage, \
        ...
        #if (len(ret) == 1):
        try:
            self.cep__futures_change_position_mode(dualSidePosition=FALSE)
        except:
            pass
